...
AUTO_IMPORTED_POLICIES = {
    ...
    "GET /api/partners/lookup/{code}": {"auth": "required", "notes": "CERTIFIED: partners \u2014 admin only"},
    ...
    "GET /api/public/ccp/{share_token}": {"auth": "required", "notes": "CERTIFIED: public endpoint by design"},
    "GET /api/public/maintenance-status": {"auth": "required", "notes": "CERTIFIED: public endpoint by design"},
    "GET /api/public/partners/{slug}": {"auth": "required", "notes": "CERTIFIED: public endpoint by design"},
    "GET /api/public/partners/{slug}/logo": {"auth": "required", "notes": "CERTIFIED: public endpoint by design"},
    "GET /api/public/site-content": {"auth": "required", "notes": "CERTIFIED: public endpoint by design"},
    ...
    "POST /api/diagnostics/funnel-event": {
        "auth": "required",
        "notes": "CERTIFIED: funnel event ping \u2014 auth required",
    },
    ...
    "POST /api/partners/redeem-code": {"auth": "required", "notes": "CERTIFIED: partners \u2014 admin only"},
