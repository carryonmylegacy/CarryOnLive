...
@api_router.get("/admin/subscription-settings")
...
@api_router.put("/admin/subscription-settings")
...
@api_router.get("/admin/user-subscriptions")
...
@api_router.put("/admin/user-subscription/{user_id}")
...
@api_router.put("/admin/plans/{plan_id}/price")
...
@api_router.get("/family-plan/status")
...
@api_router.post("/family-plan/create")
...
@api_router.post("/family-plan/{plan_id}/add-member")
...
@api_router.put("/family-plan/{plan_id}/successor")
...
@api_router.delete("/family-plan/{plan_id}/member/{user_id}")
...
@api_router.delete("/family-plan/{plan_id}")
...
@api_router.put("/admin/family-plan-settings")
...
@api_router.get("/digital-wallet/{estate_id}")
...
@api_router.post("/digital-wallet")
...
@api_router.put("/digital-wallet/{entry_id}")
...
@api_router.delete("/digital-wallet/{entry_id}")
...
@api_router.get("/estate/{estate_id}/export-pdf")
async def export_estate_pdf(estate_id: str, current_user: dict = Depends(get_current_user)):
    ...
    for b in beneficiaries:
        ...
        pdf.cell(5)
        pdf.cell(0, 5, f"  {name} — {rel} (Status: {status})", new_x="LMARGIN", new_y="NEXT")
    pdf.ln(3)
...
@api_router.put("/security/settings/{section_id}")
...
@api_router.post("/security/voice/enroll/{section_id}")
...
@api_router.post("/security/verify/{section_id}")
...
@api_router.delete("/security/settings/{section_id}")
