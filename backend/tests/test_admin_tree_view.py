...
class TestAdminStatsEndpoint:
    ...
    def test_stats_contains_user_counts(self, auth_headers):
        ...
        print(f"✓ User stats: total={users['total']}, benefactors={users['benefactors']}, beneficiaries={users['beneficiaries']}")
    ...
    def test_stats_contains_estate_info(self, auth_headers):
        ...
        print(f"✓ Estate stats: total={estates['total']}, active={estates['active']}, transitioned={estates['transitioned']}")
...
class TestAdminRevenueMetrics:
    ...
    def test_revenue_metrics_structure(self, auth_headers):
        ...
        expected_fields = ["mrr", "arr", "total_revenue", "revenue_this_month", 
                          "revenue_last_month", "mom_growth", "paying_subscribers",
                          "arpu_monthly", "churn_rate", "ltv"]
