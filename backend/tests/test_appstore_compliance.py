...
class TestHealthAndPublicEndpoints:
    ...
    def test_subscription_plans_endpoint(self):
        ...
        print(
            f"Subscription plans retrieved: {len(data['plans'])} benefactor plans, {len(data['beneficiary_plans'])} beneficiary plans"
        )
...
class TestSubscriptionStatus:
    ...
    def test_subscription_status_endpoint(self, auth_token):
        ...
        print(
            f"Subscription status retrieved: has_active_subscription={data['has_active_subscription']}, beta_mode={data['beta_mode']}"
        )
