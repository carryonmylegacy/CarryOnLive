...
class TestGuardianExportEndpoints:
    ...
    def test_export_todo_endpoint_exists(self, api_client, auth_token):
        ...
        response = api_client.post(
            f"{BASE_URL}/api/guardian/export-todo", headers=headers, json={"content": "Test to-do content"}
        )
    ...
    def test_export_iac_report_endpoint_exists(self, api_client, auth_token):
        ...
        response = api_client.post(
            f"{BASE_URL}/api/guardian/export-iac-report", headers=headers, json={"content": "Test IAC report content"}
        )
