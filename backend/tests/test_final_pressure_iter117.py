...
class TestEstateEndpoints:
    ...
    def test_get_section_permissions(self, auth_token):
        ...
        assert response.status_code == 200, f"Expected 200, got {response.status_code}"
        print(f"SUCCESS: /section-permissions returned 200")
...
class TestBeneficiaryEndpoints:
    ...
    def test_get_succession_order(self, auth_token):
        ...
        assert response.status_code == 200, f"Expected 200, got {response.status_code}"
        print(f"SUCCESS: /succession returned 200")
...
class TestChecklistAIAcceptReject:
    ...
    def test_accept_ai_item_admin(self, auth_token):
        ...
        assert response.status_code == 200, f"Expected 200 (admin should be able to accept), got {response.status_code}: {response.text}"
        data = response.json()
    ...
    def test_reject_ai_item_with_feedback_admin(self, auth_token):
        ...
        assert response.status_code == 200, f"Expected 200 (admin should be able to reject), got {response.status_code}: {response.text}"
...
class TestMessageEndpoints:
    ...
    def test_get_messages(self, auth_token):
        ...
        assert response.status_code == 200, f"Expected 200, got {response.status_code}"
        print(f"SUCCESS: /messages returned 200")
...
class TestDigitalWalletEndpoints:
    ...
    def test_get_digital_wallet(self, auth_token):
        ...
        assert response.status_code == 200, f"Expected 200 (admin should have access), got {response.status_code}: {response.text}"
        data = response.json()
...
class TestSubscriptionEndpoints:
    ...
    def test_get_subscription_status(self, auth_token):
        ...
        assert response.status_code == 200, f"Expected 200, got {response.status_code}"
        print(f"SUCCESS: /subscriptions/status returned 200")
...
class TestNotificationEndpoints:
    ...
    def test_get_notifications(self, auth_token):
        ...
        assert response.status_code == 200, f"Expected 200, got {response.status_code}"
        print(f"SUCCESS: /notifications returned 200")
...
class TestTimelineEndpoints:
    ...
    def test_get_timeline(self, auth_token):
        ...
        assert response.status_code == 200, f"Expected 200, got {response.status_code}"
        print(f"SUCCESS: /timeline returned 200")
...
class TestTransitionEndpoints:
    ...
    def test_get_transition_status(self, auth_token):
        ...
        assert response.status_code == 200, f"Expected 200, got {response.status_code}"
        print(f"SUCCESS: /transition/status returned 200")
    ...
    def test_get_dts_tasks(self, auth_token):
        ...
        assert response.status_code == 200, f"Expected 200, got {response.status_code}"
        print(f"SUCCESS: /dts/tasks returned 200")
...
class TestOpsEndpoints:
    ...
    def test_get_ops_dashboard(self, auth_token):
        ...
        assert response.status_code == 200, f"Expected 200, got {response.status_code}"
        print(f"SUCCESS: /ops/dashboard returned 200")
...
class TestSettingsEndpoints:
    ...
    def test_get_digest_preferences(self, auth_token):
        ...
        assert response.status_code == 200, f"Expected 200, got {response.status_code}"
        print(f"SUCCESS: /digest/preferences returned 200")
    ...
    def test_get_security_settings(self, auth_token):
        ...
        assert response.status_code == 200, f"Expected 200, got {response.status_code}"
        print(f"SUCCESS: /security/settings returned 200")
    ...
    def test_get_compliance_consent(self, auth_token):
        ...
        assert response.status_code == 200, f"Expected 200, got {response.status_code}"
        print(f"SUCCESS: /compliance/consent returned 200")
    ...
    def test_get_family_plan_status(self, auth_token):
        ...
        assert response.status_code == 200, f"Expected 200, got {response.status_code}"
        print(f"SUCCESS: /family-plan/status returned 200")
...
class TestHealthEndpoint:
    ...
    def test_health_check(self):
        ...
        print(f"SUCCESS: /health returned healthy with database connected")
