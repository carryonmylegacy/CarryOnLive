...
class TestBillsCRUD(TestFinancialPortalAuth):
    ...
    def test_create_bill(self, auth_headers, estate_id):
        ...
        assert data["is_auto_pay"] == True, "Auto-pay flag mismatch"
    ...
    def test_update_bill(self, auth_headers, estate_id):
        ...
        update_response = requests.put(f"{BASE_URL}/api/financial/bills/{bill_id}", json=update_data, headers=auth_headers)
...
class TestDebtsCRUD(TestFinancialPortalAuth):
    ...
    def test_update_debt(self, auth_headers, estate_id):
        ...
        update_response = requests.put(f"{BASE_URL}/api/financial/debts/{debt_id}", json=update_data, headers=auth_headers)
...
class TestAccountsCRUD(TestFinancialPortalAuth):
    ...
    def test_update_account(self, auth_headers, estate_id):
        ...
        # Update
        update_data = {
            "approximate_balance": 6500.00,
            "institution_name": "Updated Bank"
        }
        update_response = requests.put(f"{BASE_URL}/api/financial/accounts/{account_id}", json=update_data, headers=auth_headers)
        assert update_response.status_code == 200
...
class TestCustomCategories(TestFinancialPortalAuth):
    ...
    def test_delete_custom_category(self, auth_headers, estate_id):
        ...
        create_response = requests.post(f"{BASE_URL}/api/financial/categories", json=category_data, headers=auth_headers)
...
class TestFinancialSummary(TestFinancialPortalAuth):
    ...
    def test_get_financial_summary(self, auth_headers, estate_id):
        ...
        print(f"✓ Financial summary: {data['bills_count']} bills, {data['debts_count']} debts, {data['accounts_count']} accounts")
...
class TestBeneficiaryDesignation(TestFinancialPortalAuth):
    ...
    def test_update_bill_designation(self, auth_headers, estate_id):
        ...
        response = requests.put(f"{BASE_URL}/api/financial/bills/{bill_id}/designation", json=designation_data, headers=auth_headers)
    ...
    def test_update_debt_designation(self, auth_headers, estate_id):
        ...
        response = requests.put(f"{BASE_URL}/api/financial/debts/{debt_id}/designation", json=designation_data, headers=auth_headers)
        assert response.status_code == 200, f"Failed to update designation: {response.text}"
    ...
    def test_update_account_designation(self, auth_headers, estate_id):
        ...
        response = requests.put(f"{BASE_URL}/api/financial/accounts/{account_id}/designation", json=designation_data, headers=auth_headers)
        assert response.status_code == 200, f"Failed to update designation: {response.text}"
...
class TestBillPayments(TestFinancialPortalAuth):
    ...
    def test_mark_bill_paid(self, auth_headers, estate_id):
        ...
        response = requests.post(f"{BASE_URL}/api/financial/bills/{bill_id}/pay", json=payment_data, headers=auth_headers)
    ...
    def test_get_bill_payments(self, auth_headers, estate_id):
        ...
        bill_data = {
            "estate_id": estate_id,
            "name": "TEST_Payment History Bill",
            "category": "other",
            "amount": 75.00
        }
        create_response = requests.post(f"{BASE_URL}/api/financial/bills", json=bill_data, headers=auth_headers)
...
class TestErrorHandling(TestFinancialPortalAuth):
    ...
    def test_update_nonexistent_bill(self, auth_headers):
        ...
        response = requests.put(f"{BASE_URL}/api/financial/bills/nonexistent-id", json=update_data, headers=auth_headers)
        assert response.status_code == 404, f"Expected 404, got {response.status_code}"
