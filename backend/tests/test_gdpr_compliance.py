...
class TestGDPRCompliance:
    ...
    def test_get_consent_preferences(self):
        ...
        print(f"✓ GET consent preferences - marketing: {data['marketing_emails']}, analytics: {data['analytics_tracking']}, third_party: {data['third_party_sharing']}")
    ...
    def test_update_consent_marketing_emails(self):
        ...
        assert verify_data["marketing_emails"] == new_value, f"Expected {new_value}, got {verify_data['marketing_emails']}"
    ...
    def test_data_export(self):
        ...
        print(f"✓ GET data-export returned data for {user_data.get('name', 'user')} with {len(data['estates'])} estates")
    ...
    def test_retention_policy(self):
        ...
        expected_types = ["Account Data", "Estate Documents", "Messages", "Security Audit Logs"]
