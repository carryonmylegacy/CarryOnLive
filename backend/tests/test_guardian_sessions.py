...
class TestGuardianSessions:
    ...
    def test_get_chat_history_nonexistent_session(self, headers):
        ...
        response = requests.get(f"{BASE_URL}/api/chat/history/{fake_session}", headers=headers)
    ...
    def test_delete_session(self, headers):
        ...
        # Now delete it
        delete_response = requests.delete(f"{BASE_URL}/api/chat/sessions/{session_id}", headers=headers)
        ...
        verify_response = requests.get(f"{BASE_URL}/api/chat/history/{session_id}", headers=headers)
    ...
    def test_delete_nonexistent_session(self, headers):
        ...
        response = requests.delete(f"{BASE_URL}/api/chat/sessions/{fake_session}", headers=headers)
