...
class TestProfilePhotoUpload:
    ...
    def test_auth_me_returns_photo_url(self, admin_session):
        ...
        upload_resp.json().get("photo_url")
...
class TestPhotoServing:
    ...
    def test_serve_uploaded_photo(self, admin_session):
        ...
        upload_resp = session.put(
            f"{BASE_URL}/api/auth/profile-photo",
            json={"photo_data": MINIMAL_JPEG_BASE64, "file_name": "test_serve.jpg"},
        )
...
class TestPhotoRemoval:
    ...
    def test_remove_profile_photo(self, admin_session):
        ...
        upload_resp = session.put(
            f"{BASE_URL}/api/auth/profile-photo",
            json={"photo_data": MINIMAL_JPEG_BASE64, "file_name": "test_remove.jpg"},
        )
        ...
        remove_resp = session.put(
            f"{BASE_URL}/api/auth/profile-photo",
            json={"photo_data": "", "file_name": ""},
        )
