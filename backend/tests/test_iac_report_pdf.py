...
"""
    ...
    def test_export_iac_report_missing_content_field(self, auth_headers):
        ...
        print("SUCCESS: Missing content field correctly returns 422")
...
"""
        ...
        print("SUCCESS: Content with legal disclaimer processed correctly")
...
"""
        ...
        assert response.status_code == 200, f"Expected 200, got {response.status_code}"
        assert response.headers.get("Content-Type") == "application/pdf"
        print("SUCCESS: Content with JSON block processed correctly")
...
class TestExistingChecklistExport:
    ...
    def test_export_checklist_endpoint_exists(self, auth_headers):
        ...
        if response.status_code == 200:
            ...
            print("INFO: export-checklist returns 404 (no checklist items - expected for empty estate)")
