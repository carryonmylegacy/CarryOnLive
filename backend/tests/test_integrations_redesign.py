...
class TestIntegrationsUnlockRedesign:
    ...
    def test_unlock_returns_cogs_object(self):
        ...
        print(f"✓ COGS object returned: total=${cogs['total_monthly']}, verified=${cogs['verified_total']}, unverified={cogs['unverified_items']}")
...
class TestSOC2Report:
    ...
    def test_soc2_report_unauthenticated_returns_401(self):
        ...
        response = session.post(f"{BASE_URL}/api/admin/integrations/soc2-report", json={
            "password": VAULT_PASSWORD
        })
...
class TestPaidIntegrationsCosts:
    ...
    def test_railway_cost(self):
        ...
        assert railway["cost_verified"] == True, "Railway cost should be verified"
