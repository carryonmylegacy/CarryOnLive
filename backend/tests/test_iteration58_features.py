...
if not BASE_URL:
    BASE_URL = "https://family-prep-2.preview.emergentagent.com"
...
class TestDashboardReadiness:
    ...
    def test_get_estate_readiness(self, auth_headers, estate_id):
        ...
        print(f"Readiness scores: overall={data['overall_score']}, docs={data['documents']['score']}, msgs={data['messages']['score']}, checklist={data['checklist']['score']}, financials={data['financials']['score']}")
...
class TestMessageAttachmentEndpoints:
    ...
    def test_attachment_upload_and_download_flow(self, auth_headers, estate_id):
        ...
        upload_response = requests.post(
            f"{BASE_URL}/api/messages/{message_id}/upload-attachment",
            files=files,
        ...
        download_response = requests.get(
            f"{BASE_URL}/api/messages/{message_id}/attachment",
            headers=auth_headers
        )
