...
class TestOpsDashboard:
    ...
    def test_ops_dashboard_founder_access(self, founder_token):
        ...
        queues = data["queues"]
        expected_queue_fields = ["dts_total", "dts_unassigned", "support_open", 
                                 "support_unanswered", "tvt_pending", "tvt_reviewing",
                                 "verifications_pending", "escalations_open"]
    ...
    def test_ops_dashboard_operator_profiles(self, founder_token):
        ...
        if operators:
            op = operators[0]
            expected_fields = ["id", "name", "operator_role", "is_online", "tasks_assigned",
                             "tasks_active", "tasks_completed", "completion_rate", "actions_24h"]
...
class TestOperatorNotificationsToFounder:
    ...
    def test_manager_creates_worker_notifies_founder(self, manager_token, founder_token):
        ...
        op_notifs = [n for n in notifications if "Operator" in n.get("title", "") or "operator" in n.get("body", "").lower()]
