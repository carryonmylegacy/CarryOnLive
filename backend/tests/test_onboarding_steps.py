...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://dashboard-guide-6.preview.emergentagent.com').rstrip('/')
...
class TestOnboardingProgress:
    ...
    def test_onboarding_response_structure(self, auth_token):
        ...
        required_fields = ["steps", "completed_count", "total_steps", "progress_pct", "all_complete", "dismissed"]
