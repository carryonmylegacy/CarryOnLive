...
class TestAdminStatsNewFields:
    ...
    def test_admin_stats_has_new_fields(self):
        ...
        print(
            f"Admin stats new fields: pending_milestones={data['pending_milestones']}, pending_emergency={data['pending_emergency']}, p1_emergencies={data['p1_emergencies']}, open_escalations={data['open_escalations']}"
        )
