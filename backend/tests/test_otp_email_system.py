...
class TestVerifyOTPEndpoint:
    ...
    def test_verify_otp_with_invalid_otp_returns_401(self):
        ...
        response = requests.post(
            ...
            json={"email": ADMIN_EMAIL, "otp": "000000", "trust_today": False},
        )
...
class TestOTPWorkflow:
    ...
    def test_login_triggers_otp_then_resend_works(self):
        ...
        verify_response = requests.post(
            f"{BASE_URL}/api/auth/verify-otp",
            json={"email": ADMIN_EMAIL, "otp": "999999", "trust_today": False},
        )
...
class TestTrustDeviceFeature:
    ...
    def test_verify_otp_endpoint_accepts_trust_today_boolean(self):
        ...
        response_true = requests.post(
            f"{BASE_URL}/api/auth/verify-otp",
            json={"email": ADMIN_EMAIL, "otp": "123456", "trust_today": True},
        )
        ...
        response_false = requests.post(
            f"{BASE_URL}/api/auth/verify-otp",
            json={"email": ADMIN_EMAIL, "otp": "123456", "trust_today": False},
        )
