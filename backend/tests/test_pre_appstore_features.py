...
class TestErrorReportingEndpoint:
    ...
    def test_error_report_accepts_minimal_payload(self):
        ...
        payload = {"message": "Minimal error test", "stack": ""}
    ...
    def test_error_report_rejects_missing_message(self):
        ...
        payload = {"stack": "Some stack trace"}
...
class TestLoginAndAuthentication:
    ...
    def test_login_success(self):
        ...
        payload = {"email": "fulltest@test.com", "password": "Password.123"}
        ...
        print("✓ Login successful for fulltest@test.com")
