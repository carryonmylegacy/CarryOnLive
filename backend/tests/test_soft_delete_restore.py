...
class TestSupportConversations:
    ...
    def setup(self):
        ...
        TestSetup.create_test_user(self.admin_email, self.test_password, "admin", "Test Admin")
        self.admin_token = TestSetup.login(self.admin_email, self.test_password)
        
        # Try to create operator user
        TestSetup.create_test_user(self.operator_email, self.test_password, "operator", "Test Operator")
    ...
    def test_get_conversations_excludes_deleted_by_default(self):
        ...
        response = requests.get(f"{BASE_URL}/api/support/conversations", headers=headers)
        ...
        if response.status_code == 200:
            ...
            for conv in data:
                if conv.get("soft_deleted"):
                    ...
                    print(f"WARNING: Found soft_deleted conversation in default response")
    ...
    def test_get_conversations_include_deleted_admin_only(self):
        ...
        response = requests.get(f"{BASE_URL}/api/support/conversations?include_deleted=true", headers=headers)
    ...
    def test_delete_conversation_soft_deletes(self):
        ...
        delete_response = requests.delete(f"{BASE_URL}/api/admin/support/conversation/{conv_id}", headers=headers)
        
        if delete_response.status_code == 200:
            data = delete_response.json()
            assert data.get("soft_deleted") == True, "Expected soft_deleted=True in response"
    ...
    def test_restore_conversation_admin_only(self):
        ...
        if self.operator_token:
            ...
            response = requests.post(f"{BASE_URL}/api/admin/support/conversation/test-id/restore", headers=headers)
...
class TestDTSTasks:
    ...
    def setup(self):
        ...
        TestSetup.create_test_user(self.admin_email, self.test_password, "admin", "DTS Admin")
        self.admin_token = TestSetup.login(self.admin_email, self.test_password)
        
        TestSetup.create_test_user(self.operator_email, self.test_password, "operator", "DTS Operator")
        self.operator_token = TestSetup.login(self.operator_email, self.test_password)
    ...
    def test_get_all_dts_tasks_excludes_deleted(self):
        ...
        if response.status_code == 200:
            ...
            assert len(deleted_items) == 0, f"Found {len(deleted_items)} deleted items in default response"
    ...
    def test_get_dts_tasks_include_deleted_admin_only(self):
        ...
        headers = TestSetup.get_auth_headers(self.admin_token)
        response = requests.get(f"{BASE_URL}/api/dts/tasks/all?include_deleted=true", headers=headers)
    ...
    def test_restore_dts_task_admin_only(self):
        ...
        if self.operator_token:
            headers = TestSetup.get_auth_headers(self.operator_token)
            response = requests.post(f"{BASE_URL}/api/dts/tasks/fake-task-id/restore", headers=headers)
            assert response.status_code == 403, f"Expected 403 for operator, got {response.status_code}"
...
class TestVerifications:
    ...
    def setup(self):
        ...
        TestSetup.create_test_user(self.admin_email, self.test_password, "admin", "Verify Admin")
        self.admin_token = TestSetup.login(self.admin_email, self.test_password)
        
        TestSetup.create_test_user(self.operator_email, self.test_password, "operator", "Verify Operator")
        self.operator_token = TestSetup.login(self.operator_email, self.test_password)
    ...
    def test_get_verifications_excludes_deleted(self):
        ...
        if response.status_code == 200:
            ...
            assert len(deleted_items) == 0, f"Found {len(deleted_items)} deleted in default response"
    ...
    def test_get_verifications_include_deleted_admin(self):
        ...
        headers = TestSetup.get_auth_headers(self.admin_token)
        response = requests.get(f"{BASE_URL}/api/admin/verifications?include_deleted=true", headers=headers)
    ...
    def test_delete_verification_soft_deletes(self):
        ...
        delete_response = requests.delete(f"{BASE_URL}/api/admin/verifications/{verification_id}", headers=headers)
        if delete_response.status_code == 200:
            data = delete_response.json()
            assert data.get("soft_deleted") == True
    ...
    def test_restore_verification_admin_only(self):
        ...
        if self.operator_token:
            headers = TestSetup.get_auth_headers(self.operator_token)
            response = requests.post(f"{BASE_URL}/api/admin/verifications/fake-id/restore", headers=headers)
...
class TestTransitionCertificates:
    ...
    def setup(self):
        ...
        TestSetup.create_test_user(self.admin_email, self.test_password, "admin", "Trans Admin")
        self.admin_token = TestSetup.login(self.admin_email, self.test_password)
        
        TestSetup.create_test_user(self.operator_email, self.test_password, "operator", "Trans Operator")
        self.operator_token = TestSetup.login(self.operator_email, self.test_password)
    ...
    def test_get_all_certificates_excludes_deleted(self):
        ...
        headers = TestSetup.get_auth_headers(token)
        response = requests.get(f"{BASE_URL}/api/transition/certificates/all", headers=headers)
        
        if response.status_code == 200:
            data = response.json()
            deleted_items = [c for c in data if c.get("soft_deleted")]
            assert len(deleted_items) == 0, f"Found {len(deleted_items)} deleted in default"
    ...
    def test_get_certificates_include_deleted(self):
        ...
        headers = TestSetup.get_auth_headers(self.admin_token)
        response = requests.get(f"{BASE_URL}/api/transition/certificates/all?include_deleted=true", headers=headers)
    ...
    def test_soft_delete_certificate(self):
        ...
        delete_response = requests.post(f"{BASE_URL}/api/transition/certificates/{cert_id}/soft-delete", headers=headers)
        if delete_response.status_code == 200:
            data = delete_response.json()
            assert data.get("soft_deleted") == True
    ...
    def test_restore_certificate_admin_only(self):
        ...
        if self.operator_token:
            headers = TestSetup.get_auth_headers(self.operator_token)
            response = requests.post(f"{BASE_URL}/api/transition/certificates/fake-id/restore", headers=headers)
            assert response.status_code == 403, f"Expected 403, got {response.status_code}"
...
class TestRoleAccess:
    ...
    def setup(self):
        ...
        TestSetup.create_test_user(self.admin_email, self.test_password, "admin", "Role Admin")
        self.admin_token = TestSetup.login(self.admin_email, self.test_password)
        
        TestSetup.create_test_user(self.operator_email, self.test_password, "operator", "Role Operator")
        self.operator_token = TestSetup.login(self.operator_email, self.test_password)
