...
class TestSubscriptionAnalyticsAPI:
    ...
    def setup(self):
        ...
        user_login = self.session.post(f"{BASE_URL}/api/auth/login", json={
    ...
    def test_subscription_stats_returns_trial_breakdown(self):
        ...
        print(f"PASS: Trial breakdown - Active: {breakdown['active']}, Converted: {breakdown['converted']}, Churned: {breakdown['churned']}")
