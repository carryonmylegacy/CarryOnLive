...
if not BASE_URL:
    BASE_URL = 'https://secure-vault-preview-1.preview.emergentagent.com'
...
class TestSubscriptionPlans:
    ...
    def test_plans_returns_six_tiers(self):
        ...
        expected_tiers = ["premium", "standard", "base", "new_adult", "military", "hospice"]
...
class TestSubscriptionStatus:
    ...
    def test_status_returns_trial_info(self, admin_token):
        ...
        response = requests.get(f"{BASE_URL}/api/subscriptions/status", headers={
        ...
        print(f"PASS: Trial info returned - active: {trial.get('trial_active')}, "
    ...
    def test_status_returns_subscription_details(self, admin_token):
        ...
        print(f"PASS: Subscription status - active: {data.get('has_active_subscription')}, "
...
class TestVerificationUpload:
    ...
    def test_upload_requires_auth(self):
        ...
        response = requests.post(f"{BASE_URL}/api/verification/upload", data={
...
class TestAdminSubscriptionStats:
    ...
    def test_stats_returns_data(self, admin_token):
        ...
        expected_fields = ["total_users", "active_trials", "active_subscriptions", "pending_verifications"]
