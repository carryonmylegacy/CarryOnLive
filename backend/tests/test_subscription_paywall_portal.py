...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://beneficiary-fix.preview.emergentagent.com')
...
class TestLoginFlows:
    ...
    def test_login_info_carryon_account(self):
        ...
        print(f"✓ info@carryon.us login successful (admin role)")
    ...
    def test_login_fulltest_account(self):
        ...
        assert data.get('user', {}).get('is_also_benefactor') == True, "Expected is_also_benefactor=true"
        print(f"✓ fulltest@test.com login successful (benefactor, is_also_benefactor=true)")
...
class TestSubscriptionCheckout:
    ...
    def test_checkout_saves_plan_in_beta_mode(self, auth_token):
        ...
        response = requests.post(f"{BASE_URL}/api/subscriptions/checkout", json={
            ...
            "origin_url": "https://beneficiary-fix.preview.emergentagent.com"
        }, headers=headers)
