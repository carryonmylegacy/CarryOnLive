...
if not BASE_URL:
    BASE_URL = "https://todo-pdf-gen.preview.emergentagent.com"
...
class TestSuccessionHierarchy:
    ...
    def test_reorder_beneficiaries_sets_succession(self, auth_headers, estate_id):
        ...
        for idx, ben_id in enumerate(ordered_ids):
            ...
            if ben:
                ...
                print(f"  {ben['name']}: sort_order={ben.get('sort_order')}, succession_order={ben.get('succession_order')}, is_primary={ben.get('is_primary')}")
    ...
    def test_reorder_swaps_primary(self, auth_headers, estate_id):
        ...
        new_primary_name = next((b["name"] for b in beneficiaries if b["id"] == ordered_ids[0]), "Unknown")
...
class TestBeneficiaryCardFields:
    ...
    def test_beneficiaries_include_succession_order(self, auth_headers, estate_id):
        ...
        for ben in beneficiaries:
            ...
            has_sort = "sort_order" in ben
            has_succession = "succession_order" in ben
