...
class TestCheckUsername:
    ...
    def test_check_username_available(self):
        ...
        response = requests.post(f"{BASE_URL}/api/auth/check-username", json={
...
class TestCheckEmail:
    ...
    def test_check_email_exists(self):
        ...
        print(f"PASS: Existing email returns exists=true")
    ...
    def test_check_email_not_exists(self):
        ...
        print(f"PASS: Non-existing email returns exists=false")
