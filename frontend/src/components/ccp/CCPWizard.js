...
const sectionBorder = (editing) =>
  `1px solid ${editing ? 'rgba(var(--gold-rgb), 0.35)' : 'rgba(120,120,140,0.2)'}`;
            ...
            <div className="space-y-4" data-testid="ccp-wizard-review">
              ...
              {generatedPlan.self_defense_law_note && (
                <div
                  ...
                  style={{ background: 'rgba(var(--gold-rgb), 0.05)', border: '1px solid rgba(var(--gold-rgb), 0.20)' }}
                >
    ...
    <div className="rounded-xl overflow-hidden"
      ...
      <div className="flex items-center justify-between px-4 py-3">
        ...
        <button onClick={onToggle}
          ...
          style={{ background: editing ? 'rgba(var(--gold-rgb), 0.15)' : 'rgba(120,120,140,0.1)', color: editing ? '#d4af37' : 'var(--t4)' }}>
