  ...
  return (
    <div className="glass-card rounded-2xl overflow-hidden" data-testid="bill-calendar">
      ...
      <div className="flex items-center justify-between px-4 py-3" style={{ borderBottom: '1px solid var(--b)' }}>
        <button onClick={prevMonth} className="p-1.5 rounded-lg hover:bg-[var(--s)] transition-colors" data-testid="cal-prev">
        ...
        <button onClick={nextMonth} className="p-1.5 rounded-lg hover:bg-[var(--s)] transition-colors" data-testid="cal-next">
