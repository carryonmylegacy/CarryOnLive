  ...
  return (
    <div className="space-y-4 py-4">
      <div className="space-y-2">
        ...
        <Input value={form.name} onChange={e => update('name', e.target.value)} placeholder="e.g., Home Mortgage - Wells Fargo" className="input-field" data-testid="debt-name-input" />
      </div>
      <div className="space-y-2">
