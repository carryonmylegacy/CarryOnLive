          ...
          <div key={s.key} className="admin-section-block" style={{ marginBottom: 4 }}>
            <div
              ...
              style={{
                ...
                background: (isSectionActive || isTabInSectionActive)
                  ? `rgba(${rgb}, 0.10)` : 'transparent',
                border: (isSectionActive || isTabInSectionActive)
                  ? `1px solid rgba(${rgb}, 0.25)` : '1px solid transparent',
              }}
            >
              ...
              >
                ...
                <span
                  ...
                  style={{
                    ...
                    color: (isSectionActive || isTabInSectionActive) ? s.color : 'var(--t)',
                  }}
                >
                  {s.label}
                </span>
