...
const PAGES_PHASE1 = [
  {
    ...
    sections: [
      ...
      { key: 'nav', label: 'Navigation bar & footer (all marketing pages)', fields: [
        ...
        f('footer.founder', 'Footer: Founder (request-access gate while invite-only, the story once public)', 'Founder story'),
  ...
  },
  {
    ...
    sections: [
      ...
      { key: 'plans', label: 'Plan list', fields: [
        ...
        f('start.plans.legend', 'Main plans — gold-check legend', 'Gold check = added at this tier'),
        f('start.plans.invited', 'Every plan tile — beneficiary line', 'Unlimited beneficiary enrollment — free for your lifetime'),
        f('start.plans.special', 'Special pricing heading', 'Special Pricing'),
        f('start.plans.special.sub', 'Special pricing — sub-heading', 'Eligibility is verified once, usually within 24 hours.'),
        f('start.plans.special.legend', 'Special pricing — gold-check legend', 'Gold check = more than Base'),
        f('start.family.title', 'One plan box — heading', 'One plan. Nobody you invite pays.'),
        f('start.family.text', 'One plan box — text', 'Unlimited beneficiary enrollment — free for your lifetime. Your spouse, kids, and attorney see what you share at no charge. Quarterly and annual billing saves you even more.'),
      ] },
    ],
  },
];
