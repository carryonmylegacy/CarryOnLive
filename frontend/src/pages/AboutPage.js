...
import { ChevronRight, Shield, ChevronLeft } from 'lucide-react';
...
const AboutPage = () => {
  ...
  return (
    <div className="min-h-screen" style={{ background: '#080e1a' }}>
      ...
      <section className="py-16 lg:py-24" style={{ background: 'rgba(12,20,35,0.5)' }}>
        <div className="max-w-[800px] mx-auto px-6">
          ...
          {/* Quote */}
          <div className="rounded-lg p-6 lg:p-8" style={{ borderLeft: '3px solid #d4af37', background: 'rgba(212,175,55,0.04)' }}>
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-[900px] mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-6">
            <div className="rounded-xl p-6 lg:p-8" style={{ background: 'rgba(15,24,42,0.7)', border: '1px solid rgba(255,255,255,0.06)' }}>
        ...
        <div className="max-w-[1000px] mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-5">
            {[
              ...
              <div key={title} className="rounded-xl p-6" style={{ background: 'rgba(15,24,42,0.7)', border: '1px solid rgba(255,255,255,0.06)' }}>
        ...
        <div className="max-w-[800px] mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-3 gap-5">
            {[
              ...
              <div key={title} className="rounded-xl p-6 text-center" style={{ background: 'rgba(15,24,42,0.7)', border: '1px solid rgba(255,255,255,0.06)' }}>
      ...
      <section className="py-20 lg:py-28" style={{ background: 'rgba(12,20,35,0.5)' }}>
        <div className="max-w-[600px] mx-auto px-6 text-center">
          ...
          <a href="/signup" className="inline-flex items-center gap-2 px-8 py-3.5 rounded-lg font-semibold text-sm transition-all hover:brightness-110"
            style={{ background: '#d4af37', color: '#080e1a', border: '1px solid #d4af37' }}>
