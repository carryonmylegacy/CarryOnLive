  ...
  return (
    <div className="min-h-screen" style={{
      ...
      <LandingContent
        ...
        testIdSuffix="-home"
        beforeAbout={
          <section className="relative z-10 -mt-4" style={{ background: '#0E1829' }}>
            <div className="pt-24 pb-16 lg:pt-32 lg:pb-24 relative overflow-hidden rounded-t-[2.5rem]" style={{ background: '#0E1829', boxShadow: '0 -20px 60px rgba(0,0,0,0.5)' }}>
              ...
              <div className="absolute inset-0 z-[1]" style={{ background: 'linear-gradient(180deg, #0E1829 0%, #0E1829 60px, rgba(11,18,33,0.6) 50%, rgba(11,18,33,0.8) 100%)' }} />
