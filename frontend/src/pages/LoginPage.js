            ...
            <RevealSection delay={0.1} className="hidden lg:block">
              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 lg:gap-8">
                ...
                <div className="text-center sm:text-left flex-1 sm:pt-2">
                  ...
                  <a href="#about" className="inline-flex flex-col items-center justify-center gap-1.5 mt-10 px-8 sm:px-10 py-3.5 rounded-2xl cursor-pointer animate-bounce text-center"
