      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        <div className="glass-card p-8 md:p-12">
          ...
          <div className="space-y-8 text-[#C0C8D8] text-sm leading-relaxed">
            ...
            <section>
              <h2 className="text-lg font-semibold text-[var(--t)] mb-3">2. Description of Service</h2>
              <p>
                CarryOn&trade; is an estate planning and estate plan management platform that enables users to organize, secure, and communicate their estate plans to designated beneficiaries. The Service includes document storage, beneficiary management, checklist tools, AI-powered estate analysis, and related features.
              </p>
            </section>

            <section>
              <h2 className="text-lg font-semibold text-[var(--t)] mb-3">3. Account Registration</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="text-lg font-semibold text-[var(--t)] mb-3">4. SMS Communications Consent</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="text-lg font-semibold text-[var(--t)] mb-3">5. Acceptable Use</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[var(--t)] mb-3">7. Payment Terms</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[var(--t)] mb-3">8. Disclaimer of Warranties</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[var(--t)] mb-3">9. Limitation of Liability</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[var(--t)] mb-3">10. Termination</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[var(--t)] mb-3">11. Governing Law</h2>
              <p>
