...
const TrusteePage = () => {
  ...
  // === TASK LIST (DEFAULT) ===
  return (
    <div className="w-full max-w-[1400px] mx-auto p-4 lg:p-6 pt-4 lg:pt-6 pb-24 lg:pb-6 space-y-5 animate-fade-in" data-testid="dts-page">
      {/* Header */}
