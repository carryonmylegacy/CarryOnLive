...
const BeneficiaryDashboardPage = () => {
  ...
  if (loading) {
    return (
      <div className="p-4 lg:p-6 pt-[4.25rem] lg:pt-6 pb-24 lg:pb-6 space-y-6">
  ...
  return (
    <div className="p-4 lg:p-6 pt-[4.25rem] lg:pt-6 pb-24 lg:pb-6 animate-fade-in" data-testid="beneficiary-dashboard">
      {/* Sealed Banner */}
