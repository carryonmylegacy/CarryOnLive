...
const BeneficiaryDashboardPage = () => {
  ...
  if (loading) {
    return (
      <div className="p-4 lg:p-6 pt-[2.75rem] lg:pt-6 pb-24 lg:pb-6 space-y-6">
  ...
  return (
    <div className="p-4 lg:p-6 pt-[2.75rem] lg:pt-6 pb-24 lg:pb-6 animate-fade-in" data-testid="beneficiary-dashboard">
      {/* Sealed Banner */}
      ...
      <div className="glass-card p-5 text-center" style={{ borderColor: 'rgba(212,175,55,0.15)' }}>
        ...
        <p className="text-xs text-[var(--t4)] mb-4">Start your own estate plan and give your loved ones the same peace of mind.</p>
        <a href="/signup" className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl text-sm font-bold transition-transform active:scale-95" style={{ background: 'linear-gradient(135deg, #d4af37, #b8962e)', color: '#080e1a' }}>
