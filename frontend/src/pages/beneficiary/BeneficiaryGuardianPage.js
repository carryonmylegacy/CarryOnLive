...
const BeneficiaryGuardianPage = () => {
  ...
  return (
    <div className="w-full max-w-[1400px] mx-auto p-4 lg:p-6 h-[calc(100vh-4rem)] lg:h-screen flex flex-col animate-fade-in pt-4 lg:pt-6" data-testid="beneficiary-guardian">
      {/* Header */}
      <div className="mb-3">
