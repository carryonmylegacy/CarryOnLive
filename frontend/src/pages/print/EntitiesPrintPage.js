...
export default function EntitiesPrintPage() {
  ...
  // `saving` tracks the background `/render-pdf` call fired alongside
  // `window.print()` (see `handlePrintClick`) so the Print button can
  // show a spinner without blocking the OS print dialog.
