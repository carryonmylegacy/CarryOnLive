...
DARKMODE_HITS=$(grep -rEn \
  ...
  | grep -v "EstateChatPage\|FamilyTree\|LandingContent\|HomePage\|SpeakWith\|SharedPlan\|MobileNav\|Sidebar\|FounderAbout\|AboutPage\|QuickStartWizard\|QuickStartTrialPage\|components/landing/\|CustomersPage\|ChangelogPage\|ComparePage" \
  | wc -l)
