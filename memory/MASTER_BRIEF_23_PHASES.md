...
- Footer contact CANONICAL FACTS (founder-confirmed, corrected Jun 2026 — supersedes the note below): phone (703) 889-0017 IS canonical ((703) 884-1527 is superseded, founder confirmed Aug 31); address line2 canonical format is "Arlington, VA 22209" with NO "USA"/"U.S.A." suffix. Production is CORRECT on both. Do NOT flag these again.
- [SUPERSEDED — WRONG] Footer phone in production API STILL (703) 889-0017 as of this session's check — founder believed it fixed; portal save may not have persisted. Line2 missing " USA". Address line1 fixed.
