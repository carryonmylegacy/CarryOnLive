...
> - `https://estate-stable.preview.emergentagent.com`
> - `capacitor://localhost`
> - `ionic://localhost`
...
> URL (today: `https://estate-stable.preview.emergentagent.com`). If the
...
**Verified live** (Playwright on `https://estate-stable.preview.emergentagent.com`, 1440×900):
...
**Verified live** (Playwright on `https://estate-stable.preview.emergentagent.com`):
