...
- **Beneficiary Hard Delete**: Replaced soft-delete with clean hard-delete. Benefactors delete from their own estate only. Admins get a dialog: "This Estate Only" or "All Estates". Clean delete removes: beneficiary record, S3 photo, estate.beneficiaries array entry, primary_beneficiary_id, section_permissions. Succession re-ordered after delete.
